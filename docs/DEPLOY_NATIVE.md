...
>
> **✅ 已实测（2026-07-29 122.51.84.172）**：本指南 §1-§6 步骤已在本机按序执行通过 — MySQL 8.0.46 + 自编译 `minioj-backend` + nginx 1.24.0 三者常驻，5 题 / 16 用例 / admin·admin123 全通，6 端页面 + 14 API + AC / WA / CE / TLE / RE 5 态判定实测全对。Docker 3 个孤儿容器已停。
